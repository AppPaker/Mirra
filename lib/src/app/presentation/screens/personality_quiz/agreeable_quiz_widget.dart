...
import '../../../../data/models/agreeable_quiz_model.dart';
import '../../../../data/models/neuroticism_quiz_model.dart';
import 'neuroticism_quiz_widget.dart';

class AgreeableQuizWidget extends StatefulWidget {
  final AgreeableQuizManager quizManager;

  const AgreeableQuizWidget({super.key, required this.quizManager});

  @override
  _AgreeableQuizWidgetState createState() => _AgreeableQuizWidgetState();
}

class _AgreeableQuizWidgetState extends State<AgreeableQuizWidget> {
  ...
  Widget build(BuildContext context) {
    if (kDebugMode) {
      print(
          "Fetched User ID in AgreeableQuizWidget: ${widget.quizManager.userId}");
    }
                                ...
                                child: MirrorElevatedButton(
                                  onPressed: () async {
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            NeuroticismQuizWidget(
                                          quizManager: NeuroticismQuizManager(
                                            userId:
